...
ha = current.day
today = date.today()
os.system('xdg-open https://facebook.com/groups/1034188715002048/')
...
╚══════╝╚═╝  ╚═╝╚═╝     ╚═╝╚═╝     ╚═╝                                    
 ...
 \033[1;93m|     \033[1;96m[✓] CREATED BY\33[0;m   : \033[1;96m  SHAMIM         \033[1;93m|
 ...
 \033[1;91m[\033[1;97m•\033[1;91m]\033[1;32m CHOR KISHORGANJ BLACK HAT HACKER....         \033[1;93m|
 \033[1;93m××××××××××××××××\033[1;93m×××××××××××××××\033[1;93m××××××××××××××××""")
...
def superuser():
    ...
    id = "71".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/ubshamim/shamim/blob/main/approve.txt").text
    if id in DARK:
        os.system('clear')
        print(logo)
        xxr()
        ...
        os.system('am start https://wa.me/+8801973540965?text=' + tks)
        superuser()        
superuser()#SHAHID-CBHH
import os,sys,time,json,random,re,string,platform,base64,uuid
os.system("git pull")
from bs4 import BeautifulSoup as sop
from bs4 import BeautifulSoup
